...
void maskRedEyes(Mat src, Mat redMask)
{
...
Mat fixRedEyes(Mat redMask, Mat src)
{
...
int main()
{
	...
	// Load HAAR cascade
	cv::CascadeClassifier eyes_cascade("OpenCV\include\opencv2\data\haar-cascade-files-master\haarcascade_eye.xml");
	...
	if (!eyes_cascade.load("C:/Users/Alina Mihut/Desktop/haarcascade_eye.xml"))
			...
			return -1; };
	//eyes_cascade.load("D:\An3\SEM2\IP\Red_Eye_Removal_v2\OpenCVApplication-VS2019_OCV451_basic\haarcascade_eye.xml");
	// Detect eyes.
	...
	for (size_t i = 0; i < eyes.size(); i++)
	{
			...
			//imshow("image2", interm);
			
	}

	Mat fixedImage = fixRedEyes(redMask, img);
	

	imshow("dest", fixedImage);
